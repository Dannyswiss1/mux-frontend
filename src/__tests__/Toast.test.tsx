...
describe("ToastItem", () => {
  ...
  it("renders the description when provided", () => {
    render(
      <ToastItem
        toast={{ id: "1", type: "success", message: "Done", description: "Operation completed" }}
        onDismiss={jest.fn()}
      />,
    );
  ...
  it("auto-dismisses after the specified duration", () => {
    ...
    render(
      <ToastItem
        toast={{ id: "1", type: "info", message: "Auto dismiss", duration: 3000 }}
        onDismiss={onDismiss}
      />,
    );
...
describe("ToastContainer", () => {
  ...
  it("applies position classes correctly", () => {
    ...
    const { container } = render(
      <ToastContainer toasts={toasts} onDismiss={jest.fn()} position="bottom-left" />,
    );
